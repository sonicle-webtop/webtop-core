 ...
 */
Ext.define('Sonicle.webtop.core.admin.model.PecBridgeRelay', {
	extend: 'WTA.ux.data.BaseModel',
	requires: [
		'Sonicle.data.writer.Json'
	],
	proxy: WTF.apiProxy('com.sonicle.webtop.core.admin', 'ManagePecBridgeRelay', 'data', {
		writer: {
			type: 'sojson',
	...
	idProperty: 'relayId',
	fields: [
		WTF.field('relayId', 'int', false),
		WTF.field('domainId', 'string', false),
		WTF.field('userId', 'string', false),
		WTF.field('pecAddress', 'string', false, {
			validators: ['email']
		}),
