...
Ext.define('Sonicle.webtop.core.sdk.PublicService', {
	...
	alternateClassName: 'WT.sdk.PublicService',
	requires: [
		'WT.sdk.model.PublicServiceVars'
	],
	statics: {
	...
	constructor: function(cfg) {
		...
		try {
			...
			me.vars = Ext.create('WT.sdk.model.PublicServiceVars', cfg.varsData);
		}
	},
	...
	getMainComponent: function() {
		return this.getRef(WT.sdk.PublicService.MAIN_REF_NAME);
	},
	...
	setMainComponent: function(cmp) {
		if(cmp) this.addRef(WT.sdk.PublicService.MAIN_REF_NAME, cmp);
	}
});
