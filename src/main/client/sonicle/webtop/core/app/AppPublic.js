...
Ext.define('Sonicle.webtop.core.app.AppPublic', {
	...
	launch: function() {
		...
		Ext.each(WTS.services, function(obj) {
			desc = Ext.create('WT.DescriptorPublic', {
				index: obj.index,
			...
			WT.loadCss(desc.getPath()+'/laf/default/service.css');
			WT.loadCss(desc.getPath()+'/laf/default/service-override.css');
			WT.loadCss(desc.getPath()+'/laf/default/service-crisp.css');
			WT.loadCss(desc.getPath()+'/laf/default/service-override-crisp.css');
