 ...
 */
Ext.define('Sonicle.webtop.core.sdk.mixin.ItemWithinFolder', {
	alternateClassName: 'WTA.sdk.mixin.ItemWithinFolder',
	extend: 'Ext.Mixin',
	requires: [
		'WTA.util.FoldersTree2'
	],
	mixinConfig: {
		id: 'wtitemwithinfolder'
	},
	...
	getOriginDN: function() {
		return this.get(this.originDNField);
	},
	
	getOwnerPid: function() {
		return this.get(this.ownerIdField);
	},
	
	getFolderPerms: function() {
		return this.get(this.folderPermsField);
	},
