 ...
 */
Ext.define('Sonicle.webtop.core.sdk.model.FolderSharingRights', {
	alternateClassName: 'WTA.sdk.model.FolderSharingRights',
	...
	fields: [
		...
		WTF.field('folderManage', 'boolean', false, {defaultValue: false}),
		...
		WTF.field('itemsCreate', 'boolean', false, {defaultValue: false}),
		WTF.field('itemsUpdate', 'boolean', false, {defaultValue: false}),
		WTF.field('itemsDelete', 'boolean', false, {defaultValue: false})
