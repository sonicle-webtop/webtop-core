 ...
 */
Ext.define('Sonicle.webtop.core.ux.plugin.FieldPermStatus', {
	extend: 'Sonicle.plugin.FieldIcon',
	alias: 'plugin.wtfieldpermstatus',
	
	iconCls: 'wt-icon-permission-{0}',
	adminIconCls: 'wt-icon-permission-{0}-off',
	...
	setPermStatus: function(allowed) {
		...
		if (me.enabled) {
			...
			me.setIconCls(Ext.String.format(me.isAdmin ? me.adminIconCls : me.iconCls, me.permName(allowed)));
			if (!Ext.isEmpty(ttip)) me.setTooltip(ttip);
		}
	},
