...
Ext.define('Sonicle.webtop.core.model.ServiceVars', {
	...
	fields: [
		WTF.roField('docServerEnabled', 'boolean'),
		...
		WTF.field('wtRMeEnabled', 'boolean'),
		...
		WTF.roField('wtPopMeetingProviders', 'string'),
		...
		WTF.roField('colorScheme', 'string'), // RO: only changed after a reload
