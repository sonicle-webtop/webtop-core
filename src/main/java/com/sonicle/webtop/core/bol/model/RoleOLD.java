...
public class RoleOLD {
	...
	public RoleOLD(String roleUid, String domainId, String name, String description) {
	...
	public boolean equals(Object obj) {
		if(obj instanceof RoleOLD == false) return false;
		if(this == obj) return true;
		final RoleOLD otherObject = (RoleOLD) obj;
