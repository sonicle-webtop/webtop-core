 ...
 * @author malbinola
 */
public class JsDomainPwdPolicies {
	public Short levenThres;
	public Short tokenSize;
	...
	public JsDomainPwdPolicies(short levenThres, short tokenSize, DomainEntity.PasswordPolicies policies) {
		...
		this.complexity = policies.getComplexity();
		this.consecutiveDuplChars = policies.getAvoidConsecutiveChars();
		this.oldSimilarity = policies.getAvoidOldSimilarity();
		this.usernameSimilarity = policies.getAvoidUsernameSimilarity();
	}
