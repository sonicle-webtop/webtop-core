 ...
 * @author malbinola
 */
public class CustomizedAcceptHeaderOpenApiResource extends AcceptHeaderOpenApiResource {
	...
	protected Response getOpenApi(HttpHeaders headers, ServletConfig config, Application app, UriInfo uriInfo, String type) throws Exception {
		...
		return super.getOpenApi(new MoreHttpHeaders(headers, requestURL), config, app, uriInfo, type);
	}
}
