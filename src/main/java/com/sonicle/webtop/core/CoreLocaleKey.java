...
public class CoreLocaleKey {
	...
	public static final String TPL_LOGIN_USERNAME_LABEL = "tpl.login.username.label";
	public static final String TPL_LOGIN_USERNAME_PLACEHOLDER = "tpl.login.username.placeholder";
	public static final String TPL_LOGIN_PASSWORD_LABEL = "tpl.login.password.label";
	...
	public static final String TPL_LOGIN_DOMAIN_PLACEHOLDER = "tpl.login.domain.placeholder";
	public static final String TPL_LOGIN_REMEMBERME_LABEL = "tpl.login.rememberme.label";
	...
	public static final String TPL_PWCHANGE_PASSWORD_LABEL = "tpl.password.password.label";
	public static final String TPL_PWCHANGE_PASSWORD_PLACEHOLDER = "tpl.password.password.placeholder";
	public static final String TPL_PWCHANGE_PASSWORDCONFIRM_LABEL = "tpl.password.passwordConfirm.label";
	public static final String TPL_PWCHANGE_PASSWORDCONFIRM_PLACEHOLDER = "tpl.password.passwordConfirm.placeholder";
	public static final String TPL_PWCHANGE_SUBMIT_LABEL = "tpl.password.submit.label";
	public static final String TPL_PWCHANGE_ERROR_EMPTYFIELD = "tpl.password.error.emptyfield";
	public static final String TPL_PWCHANGE_ERROR_MINLENGTH = "tpl.password.error.minlength";
	public static final String TPL_PWCHANGE_ERROR_COMPLEXITY = "tpl.password.error.complexity";
	public static final String TPL_PWCHANGE_ERROR_CONSECUTIVEDUPLCHARS = "tpl.password.error.consecutiveduplchars";
	public static final String TPL_PWCHANGE_ERROR_USERNAMESIMILARITY = "tpl.password.error.usernamesimilarity";
	public static final String TPL_PWCHANGE_ERROR_PASSWORDSIMILARITY = "tpl.password.error.passwordsimilarity";
	public static final String TPL_PWCHANGE_ERROR_CONFIRMNOTMATCH = "tpl.password.error.confirmnotmatch";
	public static final String TPL_PWCHANGE_ERROR_MUSTBEDIFFERENT = "tpl.password.error.mustbedifferent";
	public static final String TPL_PWCHANGE_ERROR_UNEXPECTED = "tpl.password.error.unexpected";
