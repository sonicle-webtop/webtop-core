/**
 * @copyright ÃÂ©Melqui Brito. All rights reserved.
 * @author Melqui Brito
                        ...
                        if (s[i].trim().replace(/(^\s+|\s+$)/g, "").length > 0) {
                            for (j; j < w.length; j++) {
                                ...
                                for (let k = 0; k < w[j].length; k++) {
                                    if (w[j][k].match(/([a-z'ÃÂ¡ÃÂ ÃÂ¢ÃÂ£ÃÂ¤ÃÂ©ÃÂ¨ÃÂªÃÂ«ÃÂ­ÃÂ¬ÃÂ®ÃÂ¯ÃÂ³ÃÂ²ÃÂ´ÃÂµÃÂ¶ÃÂºÃÂ¹ÃÂ»ÃÂ¼])/i)) {
