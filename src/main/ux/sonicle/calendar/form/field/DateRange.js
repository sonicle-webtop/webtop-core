 ...
 */
Ext.define('Sonicle.calendar.form.field.DateRange', {
     ...
     * as defined in {@link Sonicle.calendar.data.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(!v) {
            return;
        ...
        else if(v[Sonicle.calendar.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[Sonicle.calendar.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[Sonicle.calendar.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[Sonicle.calendar.data.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[Sonicle.calendar.data.EventMappings.IsAllDay.name]);
        }
    },
