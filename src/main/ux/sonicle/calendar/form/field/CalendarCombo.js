/**
 * @class Sonicle.calendar.form.field.CalendarCombo
 ...
 */
Ext.define('Sonicle.calendar.form.field.CalendarCombo', {
    ...
    initComponent: function(){
        this.valueField = Sonicle.calendar.data.CalendarMappings.CalendarId.name;
        this.displayField = Sonicle.calendar.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item ext-color-{' + Sonicle.calendar.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function(value){
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[Sonicle.calendar.data.CalendarMappings.CalendarId.name] : val); 
        }
        return '';
    },
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[Sonicle.calendar.data.CalendarMappings.CalendarId.name];
        }
