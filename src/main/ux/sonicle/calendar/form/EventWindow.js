/**
 * @class Sonicle.calendar.form.EventWindow
 * @extends Ext.Window
 ...
 */
Ext.define('Sonicle.calendar.form.EventWindow', {
     ...
     * @param {Sonicle.calendar.form.EventWindow} this
     ...
     * (by default, an instance of {@link Sonicle.calendar.EventEditForm}. Handling code should hide this window
     * and transfer the current event record to the appropriate instance of the detailed form by showing it
     * and calling {@link Sonicle.calendar.EventEditForm#loadRecord loadRecord}.
     * @param {Sonicle.calendar.form.EventWindow} this
     * @param {Sonicle.calendar.EventRecord} rec The {@link Sonicle.calendar.EventRecord record} that is currently being edited
     */
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || Sonicle.Date.add(start, {hours: 1});
            
            data[M.StartDate.name] = start;
            data[M.EndDate.name] = end;
            data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != Sonicle.Date.add(end, {millis: 1}).getDate();
            rec = new Sonicle.calendar.data.EventModel(data);
