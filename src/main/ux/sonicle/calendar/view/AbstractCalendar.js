...
Ext.define('Sonicle.calendar.view.AbstractCalendar', {
    ...
    prepareEventGrid: function(evts, w, d) {
        ...
        evts.each(function(evt) {
            ...
            days = Sonicle.Date.diffDays(
            Sonicle.Date.max(me.viewStart, evt.data[M.StartDate.name]),
            Sonicle.Date.min(me.viewEnd, evt.data[M.EndDate.name])) + 1;

            if (days > 1 || Sonicle.Date.diffDays(evt.data[M.StartDate.name], evt.data[M.EndDate.name]) > 1) {
