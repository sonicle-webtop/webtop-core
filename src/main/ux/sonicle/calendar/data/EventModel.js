 ...
 * {@link Sonicle.calendar.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as 
 ...
 *
 *      rec = new Sonicle.calendar.data.EventModel({
 ...
 *      });
 *
 * If you have overridden any of the record's data mappings via the Sonicle.calendar.data.EventMappings object
 ...
 */
Ext.define('Sonicle.calendar.data.EventModel', {
    ...
    statics: {
        /**
         * Reconfigures the default record definition based on the current {@link Sonicle.calendar.data.EventMappings EventMappings}
         * object. See the header documentation for {@link Sonicle.calendar.data.EventMappings} for complete details and 
         ...
         * documentation of `Sonicle.calendar.data.EventMappings`.
         *
         * @static
        ...
        reconfigure: function() {
            var me = this,
                Mappings = Sonicle.calendar.data.EventMappings;
