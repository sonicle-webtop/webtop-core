...
public class ApiApiKeyAllOf   {
   ...
   * The ApiKey ID.
   **/
  public ApiApiKeyAllOf id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ApiApiKeyAllOf createdAt(String createdAt) {
   ...
   **/
  public ApiApiKeyAllOf updatedAt(String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ApiApiKeyAllOf apiKeyAllOf = (ApiApiKeyAllOf) o;
    return Objects.equals(this.id, apiKeyAllOf.id) &&
        Objects.equals(this.createdAt, apiKeyAllOf.createdAt) &&
        Objects.equals(this.updatedAt, apiKeyAllOf.updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiApiKeyAllOf {\n");
